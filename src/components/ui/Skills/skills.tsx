  ...
  return (
    <div>
      ...
      <ul className="skills-grid">
        ...
        />
        <Card name="CSS" link="/icons/css.png" color="rgba(114,176,221, 0.5)" />
        <Card
          name="Figma"
        ...
        />
        <Card name="HTML" link="/icons/html.png" color="rgba(255,111,0,0.5)" />
        <Card
          name="Javascript"
          link="/icons/javascript.png"
          color="rgba(254,214,0,0.5)"
        />
        <Card name="Jira" link="/icons/jira.png" color="rgba(38,132,254,0.5)" />
        <Card
          name="MongoDB"
